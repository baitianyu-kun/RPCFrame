...
bool rocket::HTTPRequestParser::parse(std::string &str) {
...
bool rocket::HTTPRequestParser::parseHTTPRequestLine(const std::string &tmp) {
...
bool rocket::HTTPRequestParser::parseHTTPRequestHeader(const std::string &tmp) {
...
bool rocket::HTTPResponseParser::parse(std::string &str) {
    // while (true) {
...
bool rocket::HTTPResponseParser::parseHTTPResponseLine(const std::string &tmp) {
...
bool rocket::HTTPResponseParser::parseHTTPResponseHeader(const std::string &tmp) {
    if (tmp.empty() || tmp == g_CRLF_DOUBLE) {
        return true;
    }
    // Host: developer.mozilla.org\r\n
